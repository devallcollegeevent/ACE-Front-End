...
to {
  ...
  animation: ${$} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,z=({toast:e})=>{let{icon:t,type:a,iconTheme:r}=e;return void 0!==t?"string"==typeof t?o.createElement(W,null,t):t:"blank"===a?null:o.createElement(V,null,o.createElement(k,{...r}),"loading"!==a&&o.createElement(Y,null,"error"===a?o.createElement(U,{...r}):o.createElement(j,{...r})))},H=f("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
