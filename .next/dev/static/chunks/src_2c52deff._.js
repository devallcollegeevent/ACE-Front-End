...
const createDraftEventApi = async (payload)=>api.post("/events/draft", payload);
const autoSaveEventApi = async (id, payload)=>api.patch(`/events/${id}`, payload);
const publishEventApi = async (id)=>api.post(`/events/${id}/publish`);
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
;
;
function MediaTickets({ onBack, onSubmit }) {
    _s();
    ...
    const [certification, setCertification] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [accommodation, setAccommodation] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MediaTickets.useEffect": ()=>{
            async function loadPerks() {
                try {
                    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$event$2e$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPerksApi"])();
                    console.log("PERKS ===>", res);
                    if (res?.success) {
                        setPerksList(res.data);
                    }
                } catch (err) {
                    console.error("Perks fetch failed", err);
                }
            }
            loadPerks();
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MediaTickets.useEffect": ()=>{
            async function loadCertifications() {
                try {
                    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$event$2e$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCertificationsApi"])();
                    console.log("CERTIFICATION ===>", res);
                    if (res?.success) {
                        setCertList(res.data);
                    }
                } catch (err) {
                    console.error("Certification fetch failed", err);
                }
            }
            loadCertifications();
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MediaTickets.useEffect": ()=>{
            async function loadAccommodation() {
                try {
                    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$event$2e$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAccommodationsApi"])();
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                        ...
                                        children: [
                                            ...
                                            perksList.map((perk)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                    value: perk.id,
                                                    children: perk.perkName
                                                }, perk.id, false, {
                                                    fileName: "[project]/src/app/dashboard/space/create/steps/MediaTickets.js",
                                                    lineNumber: 184,
                                                    columnNumber: 17
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                        ...
                                        children: [
                                            ...
                                            certList.map((Certification)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                    value: Certification.id,
                                                    children: Certification.certName
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                        ...
                                        children: [
                                            ...
                                            accommodationList.map((accommodation)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                    value: accommodation.id,
                                                    children: accommodation.accommodationName
...
_s(MediaTickets, "MTwHxnCMWtDQ1RUAJmeT6gJ8l6U=");
_c = MediaTickets;
var _c;
...
function CreateEvent() {
    ...
    /* ================= STEP 1 → VALIDATE + CREATE DRAFT ================= */ const handleStep1Next = async ()=>{
        try {
            //VALIDATE STEP 1 DATA
            await createEv.validate(formData.organizer, {
                abortEarly: false
            });
            //CREATE / AUTOSAVE DRAFT
            if (!eventId) {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$event$2e$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createDraftEventApi"])(formData);
                console.log("DRAFT CREATED:", res);
                if (res?.success) {
                    setEventId(res.data.id);
                }
            } else {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$event$2e$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["autoSaveEventApi"])(eventId, formData);
            }
            setStep(2);
        } catch (err) {
            console.error("STEP 1 VALIDATION ERROR", err.errors);
            alert(err.errors[0]);
        }
    };
    /* ================= STEP 2 → VALIDATE + AUTOSAVE ================= */ const handleStep2Next = async ()=>{
        try {
            ...
            console.error("STEP 2 VALIDATION ERROR", err.errors);
            alert(err.errors[0]);
        }
    };
    /* ================= STEP 3 → FINAL SUBMIT ================= */ const handlePublish = async ()=>{
        try {
            await createEventStep3Schema.validate(formData.media, {
                abortEarly: false
            });
            console.log("FINAL PAYLOAD >>>", formData);
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$event$2e$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["publishEventApi"])(eventId);
            console.log("EVENT PUBLISHED:", res);
            ...
            console.error("STEP 3 VALIDATION ERROR", err.errors);
            alert(err.errors[0]);
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CreateEvent, "8HF8abUXEfMvHn1F99DApx4nwN8=");
_c = CreateEvent;
var _c;
...
//# sourceMappingURL=src_2c52deff._.js.map