...
function EventSlider({ title, data = [] }) {
    ...
    const handleCardClick = (eventId)=>{
        const encryptedId = enco(eventId);
...
function Footer() {
    ...
    /* GLOBAL LOADING ON MOUNT */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Footer.useEffect": ()=>{
            setLoading(true);
            return ({
                "Footer.useEffect": ()=>{
...
_s(Footer, "SXoCYjw9q0kIuYYeY7MjQOUv6nQ=", false, function() {
    return [
...
_s(LandingPage, "7t7tebEnw6aMB7kF5YoAK3CprL8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$LoadingContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLoading"]
    ];
});
...
//# sourceMappingURL=src_efc4c256._.js.map