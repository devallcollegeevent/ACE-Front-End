...
function UserLoginPage() {
    ...
    const onSubmit = async (e)=>{
        e.preventDefault();
        try {
            await userLoginSchema.validate(form, {
                abortEarly: false
            });
            const res = await loginApi(form);
            if (!res?.status || !res?.token) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(res?.message || MSG_LOGIN_FAILED);
            saveToken(res.token);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(MSG_LOGIN_SUCCESS_USER);
            router.push("/auth/user/signup");
        } catch (err) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(err.errors?.[0] || MSG_LOGIN_FAILED);
        }
    };
...
//# sourceMappingURL=src_361f35b1._.js.map